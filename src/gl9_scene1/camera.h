...
public:
  ...
  /*!
   * Create new StaticCamera that will generate viewMatrix and projectionMatrix based on its position, up and back vectors
  ...
  /*!
   * Update StaticCamera viewMatrix based on up, position and back vectors
   */
  void update();
