...
public:
  ...
  glm::vec3 back{0.5,0,-1};

  glm::mat4 viewMatrix;
  glm::mat4 projectionMatrix;

  /*!
   * Create new ThirdPersonCamera that will generate viewMatrix and projectionMatrix based on its position, up and back vectors
  ...
  /*!
   * Update ThirdPersonCamera viewMatrix based on up, position and back vectors
   */
  void update();
